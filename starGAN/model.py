...
class Solver(object):
    ...
    def __init__(self, celeba_loader, rafd_loader, config, wandb):
        ...
        self.service_attrs=config.service_attrs
        ...
        self.device=torch.cuda.set_device(config.gpu_id)
        # Directories.
...
#train
#
#    def create_labels(self, c_org, c_dim=5, dataset='CelebA',selected_attrs=None, service_attrs=None):
